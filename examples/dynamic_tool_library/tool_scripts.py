...
# ---------------------------------------------------------------------------
# Router / Dispatcher Logic (moved to framework.tool_catalog.router; re-exported
# here so existing manifests and imports keep working)
# ---------------------------------------------------------------------------

from framework.tool_catalog.router import (  # noqa: F401  (re-export)
    DEFAULT_TOOL_ID,
    classify_intent,
