"""V4 Generate Protocol LLM Edge — thin subclass wrapper.
...
@register_edge_type("llm_generate")
class GenerateLLMEdgeV4(LLMEdgeV4):
    """LLMEdgeV4 with agent_mode='generate'."""

    def __init__(self, *args, **kwargs):
        kwargs["agent_mode"] = "generate"
        kwargs.setdefault("edge_type", "llm_generate")
