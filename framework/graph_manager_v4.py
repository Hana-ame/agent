...
Moved from ``framework.server.manager`` to ``framework.graph_manager_v4`` so that
runtime modules (``sse_executor_v4``, ``workflow_executor_v4``, ``http_executor_v4``)
can depend on this core layer without importing from the server package.
"""
