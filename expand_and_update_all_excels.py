...
def get_searched_and_designed_rows():
    ...
    new_designed_items = [
        ("EXP-REV-01", "【机制突破】逆序目标对齐 L4_D128 (低位LSD优先输出)", 4, 128, 4000, 32, "3e-4",
         ...
         "【设计假设/突破add4瓶颈】CoT草稿由个位向千位推导(LSD->MSD)，但传统答案却高位优先，强迫模型在最后输出时进行长程反向寻址。本设计改为低位优先输出答案(如975代579)，预期注意力对齐零时延，add4准确率突破至80%+。"),
        
        ("EXP-REV-02", "【机制突破】逆序目标对齐 L2_D64 轻量级对照 (LSD优先)", 2, 64, 4000, 32, "3e-4",
         ["SFT监督", "CoT竖式", "单样本Single"],
         "未跑", "未跑", "未跑", "未跑", "未跑", "未跑", "未跑", "未跑", "—", "未跑",
         "【设计假设/轻量架构跨越】验证在16万极小参数模型上，消除反向寻址是否能让L2·D64直接解锁原本L4才能掌握的3位进位。"),

        ("EXP-CURR-01", "【机制突破】进位链深度课程采样 (K=0..4级联进位退火)", 4, 128, 4000, 32, "3e-4",
         ["SFT监督", "CoT竖式", "4位加权", "单样本Single"],
         "未跑", "未跑", "未跑", "未跑", "未跑", "未跑", "未跑", "未跑", "—", "未跑",
         "【设计假设/精准剥离进位深度】不再按操作数位数分级，而是按级联进位次数K设计阶梯采样(K=0零进位, K=1单进位, K=4连续雪崩)。预期大幅提高高阶连续进位的注意力鲁棒性。"),

        ("EXP-CURR-02", "【机制突破】极端4级雪崩进位压力测试 (9999+1类100%覆盖)", 4, 128, 4000, 32, "3e-4",
         ["SFT监督", "CoT竖式", "4位加权", "单样本Single"],
         "未跑", "未跑", "未跑", "未跑", "未跑", "未跑", "未跑", "未跑", "—", "未跑",
         "【设计假设/极限承压】全量训练最极端的全进位溢出算式，检验极小Transformer在进位累加器连续饱和状态下的表征极限。"),

        ("EXP-UT-01", "【机制突破】循环权重共享网络 Looped-UT (单Block展开4步)", 1, 128, 4000, 32, "3e-4",
         ["SFT监督", "CoT竖式", "4位加权", "单样本Single"],
         "未跑", "未跑", "未跑", "未跑", "未跑", "未跑", "未跑", "未跑", "—", "未跑",
         "【设计假设/状态机图灵化】单层Block权重在时间步上复用4次，迫使同一组注意力权重学会单步状态机转移，参数量削减75%并验证算法递归性。"),

        ("EXP-UT-02", "【机制突破】循环网络自适应展开 7 步 (跨长度外推探针)", 1, 128, 4000, 32, "3e-4",
         ["SFT监督", "CoT竖式", "4位加权", "单样本Single"],
         "未跑", "未跑", "未跑", "未跑", "未跑", "未跑", "未跑", "未跑", "—", "未跑",
         "【设计假设/打破外推0%魔咒】使用UT-01训练的循环网络，在测试5-7位题目时自适应迭代7步，预期首次打破相对位置与绝对位置在长题上的0%封锁。"),

        ("EXP-VERIFY-01", "【机制突破】正反双向自验算 CoT (输出 c 后反算 c-b=a)", 4, 128, 4000, 32, "3e-4",
         ["SFT监督", "CoT竖式", "4位加权", "单样本Single"],
         "未跑", "未跑", "未跑", "未跑", "未跑", "未跑", "未跑", "未跑", "—", "未跑",
         "【设计假设/闭环自校正】在CoT末尾增加反向验算式，通过自注意力同时建立正向进位图与反向借位图，预期将答案一致性推至全新高度。"),

        ("EXP-VERIFY-02", "【机制突破】草稿篡改自纠错强化学习 (破Reader局限)", 4, 128, 500, 8, "1e-5",
         ["自问自答", "纯RL_GRPO", "CoT竖式"],
         "未跑", "未跑", "未跑", "未跑", "未跑", "未跑", "未跑", "未跑", "—", "未跑",
         "【设计假设/从Reader跃升Reasoner】在草稿中随机注入20%的错误进位，若模型在验算中指出并修正错误则给予GRPO高额奖励，预期顺从错误率由100%降至30%以下。")
    ]
...
def render_additive_table(ws, title, subtitle, rows, cfg_dir=None):
    ...
    h_res = ["Add1 %", "Add2 %", "Add3 %", "Add4 %", "Sub1 %", "Sub2 %", "Sub3 %", "Sub4 %", "唯一式 (Unique)", "Loss 损失", "评测协议", "耗时 (s)", "实测现象与表现记载 (符合预期/机制归因)"]
